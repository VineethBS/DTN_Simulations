function [queueLengths, epochs, numInfectedRelays, averageQueueLength, averageDelay] = simulate_CTMC_withQueueEpochTrace(arrivalRate, meetingRate, numberOfRelays, numberOfCopies, initialQueueLengthLimit, maxNumberOfEpochs)
...
numInfectedRelays = zeros(1, maxNumberOfEpochs);

for e = 1:maxNumberOfEpochs
    queueLengths(e) = q;
    epochs(e) = currentTime;
    numInfectedRelays(e) = n;
