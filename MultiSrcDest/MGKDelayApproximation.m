function averageDelay = MGKDelayApproximation(arrivalRate, meetingRate, numRelays, numCopies, numSources)

EX = (numSources + 1) / meetingRate;
EX2 = 2/(meetingRate^2) + 2/(numSources^2)/(meetingRate^2) + (numSources - 1) * (1/(meetingRate^2) + 2/numSources/(meetingRate^2) + 3/(numSources^2)/(meetingRate^2)) ...
