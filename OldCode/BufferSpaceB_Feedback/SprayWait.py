...
# CHANGE: 26-06-2019 - inclusion of instantaneous packet feedback. Code has been changed from the one in the ../InfiniteBuffer folder
    ...
    def meet_destination(self, dest):
        while True:
            ...
            if len(self.queue) > 0:
                ...
                # del self.queue[0]; # the packet will be deleted when the delete packet on delivery is called
